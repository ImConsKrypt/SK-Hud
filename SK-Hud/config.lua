...
--- Planned default settings, eventually will be able to modify this in game per user via config NUI.
Config.useFontAwesome = true -- Curently does nothing if set to false ~ ConsKrypt
